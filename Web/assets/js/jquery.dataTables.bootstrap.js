...
$.extend(true, $.fn.dataTable.defaults, {
    ...
    "oLanguage": {
        "sLengthMenu": "Display234234 _MENU_ records"
...
$.fn.dataTableExt.oApi.fnPagingInfo = function (oSettings) {
    return {
        ...
        "iPage": Math.ceil(oSettings.fnDisplayEnd() / oSettings._iDisplayLength),
        ...
        "fnUpdate": function (oSettings, fnDraw) {
            ...
            for (i = 0, iLen = an.length ; i < iLen ; i++) {
                ...
                for (j = iStart ; j <= iEnd ; j++) {
                    ...
                    sClass = (j == oPaging.iPage) ? 'class="active"' : '';
                    $('<li ' + sClass + '><a href="#">' + j + '</a></li>')
                        .insertBefore($('li:last', an[i])[0])
                        .bind('click', function (e) {
                            e.preventDefault();
                            //oSettings._iDisplayStart = ((parseInt($('a', this).text(), 10))) * oPaging.iLength + oPaging.iLength;

...
namespace Web.Controllers
{
    public class GameRecordController : Controller
    {
        ...
        /// <returns></returns>
        public string Search(JqueryDataTableParams param, Zhp_GameRecord model)
        {
            try
            {
                //总记录数
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Add(Zhp_GameRecord model)
        {
            model.ComputerName = model.ComputerName.Trim();
            model.PlayerNickname = model.PlayerNickname.Trim();
            model.PlayerOpenId = model.PlayerOpenId.Trim();
            model.PlayerScore = model.PlayerScore.Trim();
            string msg = "";
            jsonResult result = new jsonResult();
            bool success = bll.Add(model, out msg);
        ...
        public ActionResult ShowEdit(string id)
        {
            ...
            ViewData["SecondMenu"] = "智汇屏游戏";
            ViewData["ThirdMenu"] = "游戏数据管理";
            Zhp_GameRecord model = bll.GetById(id);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Edit(Zhp_GameRecord model)
        {
            string msg = "";
            jsonResult result = new jsonResult();

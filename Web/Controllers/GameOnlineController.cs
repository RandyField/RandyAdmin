...
{
    public class GameOnlineController : Controller
    {
        Zhp_OnlineGame_BLL bll = Zhp_OnlineGame_BLL.getInstance();
        ...
        public ActionResult GetGameList()
        {
            ...
            foreach (DataRow item in dt.Rows)
            {
                list.Add(new SelectHelper()
                {
                    ...
                    value = item["GameCode"].ToString().Trim()
                });
            }
        ...
        /// <returns></returns>
        public string Search(JqueryDataTableParams param, Zhp_OnlineGame model)
        {
            try
            {
                //总记录数
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Add(Zhp_OnlineGame model)
        {
            model.GameCode = model.GameCode.Trim();
            string msg = "";
        ...
        public ActionResult ShowEdit(string id)
        {
            ...
            ViewData["SecondMenu"] = "智汇屏游戏";
            ViewData["ThirdMenu"] = "游戏运行配置";
            Zhp_OnlineGame model = bll.GetById(id);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Edit(Zhp_OnlineGame model)
        {
            string msg = "";
            jsonResult result = new jsonResult();

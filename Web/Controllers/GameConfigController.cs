...
namespace Web.Controllers
{
    ...
    {
        Zhp_GameConfig_BLL bll = Zhp_GameConfig_BLL.getInstance();
        ...
        /// <returns></returns>
        public string Search(JqueryDataTableParams param, Zhp_GameConfig model)
        {
            try
            {
                //总记录数
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Add(Zhp_GameConfig model)
        {
            model.GameCode = model.GameCode.Trim();
            model.GameName = model.GameName.Trim();
            model.CreateTime = DateTime.Now;
            string msg = "";
            jsonResult result = new jsonResult();
            bool success = false;
            DataTable dt = bll.GetCfgList(model.GameCode);
        ...
        public ActionResult ShowEdit(string id)
        {
            ...
            ViewData["SecondMenu"] = "智汇屏游戏";
            ViewData["ThirdMenu"] = "游戏库配置";
            Zhp_GameConfig model = bll.GetById(id);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Edit(Zhp_GameConfig model)
        {
            string msg = "";
            jsonResult result = new jsonResult();
